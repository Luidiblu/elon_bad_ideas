class Elon
      def self.idea
            return [
                  ...
                  "Feature for AirPods that enable a suction/gripping function when they recognize you’re trying to remove your shirt off while wearing them.",
                  "Face masks with digital displays that show subtitles of what the wearer is actively saying.",
                  "Suitcase with built in scale for items inside (scale will automatically add weight of case itself).",
                  "Social network that only lets you post once a day.",
                  "A web browser that makes tabs smaller and smaller depending on how long you've gone without looking at them, ultimately closing completely after X time goes by."
            ].sample
      end
end
